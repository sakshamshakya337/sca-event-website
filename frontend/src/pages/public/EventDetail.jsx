          ...
          <div className="container mx-auto px-4 sm:px-6 max-w-5xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-5">
                ...
                {!event.registrationNotRequired && !event.registrationOpen && event.status?.toLowerCase() !== 'completed' && (
                ...
                {event.status?.toLowerCase() === 'completed' && (
                  <div className="text-center py-2 text-sm text-gray-500 bg-gray-50 rounded-xl border border-gray-200 px-4">
