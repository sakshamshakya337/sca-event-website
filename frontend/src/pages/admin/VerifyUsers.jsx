...
import { Search, Filter, Download, ChevronLeft, ChevronRight, CheckCircle2, XCircle, Camera, ArrowRight, Eye, Users, ClipboardList, Info } from 'lucide-react'
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <div className="flex items-center gap-3 bg-white border-2 border-amber-200 px-4 py-3 rounded-xl shadow-sm min-w-[140px]">
            <div className="w-10 h-10 rounded-lg bg-amber-50 flex items-center justify-center">
              <ClipboardList className="text-amber-700" size={20} />
            </div>
            <div>
